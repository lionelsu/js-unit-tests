...
// função extremamente simples que retorna implicitamente um objecto com uma chave para cada operação com a operação em si de soma, multiplicação, divisão com o valor arredondado para baixo e subtração
...
// Esta função serve para gerar chaves, valores ou entradas de acordo com o tipo passado como parametro
