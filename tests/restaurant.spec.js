...
describe('10 - Implemente a função `createMenu`, bem como seus casos de teste', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    expect(objetoRetornado.order('sanduiche')).toEqual(['sanduiche'])
    expect(objetoRetornado.order('picanha')).toEqual('Item indisponível')
    ...
    expect(objetoRetornado.consumption).toEqual(['sanduiche', 'cerveja'])
    ...
    expect(objetoRetornado.consumption).toEqual(['sanduiche', 'cerveja', 'sanduiche'])
    ...
    expect(objetoRetornado.pay()).toEqual(29.370000000000005);
